...
class Constellation(models.Model):
    ...
    trueAnomaly_interval = models.FloatField(db_column="true_anomaly_interval")
...
class ConstellationGroup(models.Model):
    ...
    # update_time = models.DateTimeField()
    #remark = models.CharField(max_length=200, blank=True, null=True)
    isHighOrbitConstellationGroup = models.IntegerField(db_column="is_high_orbit_constellation_group",blank=True, null=True)
...
class Satellite(models.Model):
    ...
    showName = models.CharField(db_column="name", max_length=100)
    nodeType = models.IntegerField(db_column="node_type")
    apogeeAltitude = models.FloatField(db_column="apogee_altitude", blank=True, null=True)
    perigeeAltitude = models.FloatField(db_column="perigee_altitude", blank=True, null=True)
    inclination = models.FloatField(blank=True, null=True)
...
class SpectrumConfig(models.Model):
    ...
    experiment_id = models.IntegerField()
    constellation_id = models.BigIntegerField()
    uub_ch_bw = models.FloatField(blank=True, null=True)
    uub_ch_num = models.IntegerField(blank=True, null=True)
    uub_bw_tot = models.FloatField(blank=True, null=True)
    uub_ch_carries = models.TextField(blank=True, null=True)
    uub_ch_k = models.IntegerField(blank=True, null=True)
    uub_ch_polar = models.TextField(blank=True, null=True)
    uub_mod_cod = models.TextField(blank=True, null=True)
    uub_roll_off = models.FloatField(blank=True, null=True)
    udb_ch_bw = models.FloatField(blank=True, null=True)
    udb_ch_num = models.IntegerField(blank=True, null=True)
    udb_bw_tot = models.FloatField(blank=True, null=True)
    udb_ch_carries = models.TextField(blank=True, null=True)
    udb_ch_k = models.IntegerField(blank=True, null=True)
    udb_ch_polar = models.TextField(blank=True, null=True)
    udb_mod_cod = models.TextField(blank=True, null=True)
    udb_roll_off = models.FloatField(blank=True, null=True)
    fub_ch_bw = models.FloatField(blank=True, null=True)
    fub_ch_num = models.IntegerField(blank=True, null=True)
    fub_bw_tot = models.FloatField(blank=True, null=True)
    fub_ch_carries = models.TextField(blank=True, null=True)
    fub_ch_k = models.IntegerField(blank=True, null=True)
    fub_ch_polar = models.TextField(blank=True, null=True)
    fub_mod_cod = models.TextField(blank=True, null=True)
    fub_roll_off = models.FloatField(blank=True, null=True)
    fdb_ch_bw = models.FloatField(blank=True, null=True)
    fdb_ch_num = models.IntegerField(blank=True, null=True)
    fdb_bw_tot = models.FloatField(blank=True, null=True)
    fdb_ch_carries = models.TextField(blank=True, null=True)
    fdb_ch_k = models.IntegerField(blank=True, null=True)
    fdb_ch_polar = models.TextField(blank=True, null=True)
    fdb_mod_cod = models.TextField(blank=True, null=True)
    fdb_roll_off = models.FloatField(blank=True, null=True)
    create_time = models.DateTimeField(blank=True, null=True)
    update_time = models.DateTimeField(blank=True, null=True)
    remark = models.CharField(max_length=255, blank=True, null=True)
    uub_fec = models.TextField(blank=True, null=True)
    udb_fec = models.TextField(blank=True, null=True)
    fub_fec = models.TextField(blank=True, null=True)
    fdb_fec = models.TextField(blank=True, null=True)
    uub_frequency_point = models.IntegerField()
    udb_frequency_point = models.IntegerField()
    fub_frequency_point = models.IntegerField()
    fdb_frequency_point = models.IntegerField()
